...
/** This file contains the actual implementations of the formatting functions for iOS using NSNumberFormatter.
 * The functions formatFiat, formatPercentage, and formatCoinUnit are implemented to format the given amounts according to the specified rules for displaying fiat currency, percentages, and coin units respectively.
 */
